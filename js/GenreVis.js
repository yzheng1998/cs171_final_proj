class GenreVis {
  ...
  wrangleData() {
    ...
    Object.keys(vis.genreBreakdown).forEach((platform, i) => {
      vis.genreBreakdown[platform] = vis.genreBreakdown[platform].sort((a, b) =>
    ...
    vis.arrayGenre = Object.keys(vis.genreBreakdown).map(
      (key) => vis.genreBreakdown[key]
    );
  ...
  updateVis() {
    ...
    var blobAreas = blobWrapper
      ...
      .on("mouseover", function (d, i) {
        ...
        vis.svg.selectAll(".radarStroke").style("stroke-opacity", 0.1);
